 ...
 * Generated at: 2020-03-15 08:33:29 UTC
...
public final class item_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$(function(){\r\n");
      out.write("\t\t//实例化编辑器\r\n");
      out.write("\t\titemEditEditor = DREAM.createEditor(\"#itemeEditForm [name=desc]\");\r\n");
      out.write("\t\t//初始化类目选择和图片上传器\r\n");
      out.write("\t\tDREAM.init({fun:function(node){\r\n");
      out.write("\t\t\t\t//根据商品的分类id取商品 的规格模板，生成规格信息。第四天内容。\r\n");
      out.write("\t\t\t\t//DREAM.changeItemParam(node, \"itemAddForm\");\r\n");
      out.write("\t\t\t}});\r\n");
      out.write("\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t$.post(\"/item/add\",$(\"#itemeEditForm\").serialize(), function(data){\r\n");
      out.write("\t\t\tif(data.status == 200){\r\n");
      out.write("\t\t\t\t$.messager.alert('提示','增加商品成功!','info',function(){\r\n");
